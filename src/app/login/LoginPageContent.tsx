    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950/20 via-purple-950/20 to-black p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-white/60">Sign in to continue your interview practice</p>
        </div>
        ...
        <Card className="p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading || oauthLoading}
              className="w-full mt-4 flex items-center justify-center gap-3 bg-white hover:bg-white/90 text-gray-900 font-medium rounded-md px-4 py-2 transition duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {oauthLoading ? (
                <>
